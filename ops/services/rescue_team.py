...
SERVICES: list[dict[str, Any]] = [
    {
        ...
        'restart_cmd': f'bash {REPO_ROOT}/inference/vllm/scripts/launch_remote_vllm_pool.sh start',
    },
    {
        'name': 'env_provider',
        'health_urls': ['http://localhost:8006/status'],
        'log_path': '/tmp/s0-prorl.log',
        'restart_cmd': f'bash {REPO_ROOT}/ops/services/start_env_provider.sh',
    },
    {
        'name': 'live_store',
        ...
        'restart_cmd': (
            f'bash {REPO_ROOT}/ops/services/start_live_store.sh '
    ...
    },
    {
        ...
        'restart_cmd': (
            f'bash {REPO_ROOT}/ops/services/start_policy_registry.sh '
...
class ProbeAgent:
    ...
    def _check_worker_producing(self, svc: dict) -> ServiceHealth:
        ...
        try:
            ...
            from rollout_fabric.live_store.client import LiveStoreClient  # noqa: PLC0415
