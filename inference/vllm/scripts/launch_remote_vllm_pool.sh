...
#
# Usage:
#   bash inference/vllm/scripts/launch_remote_vllm_pool.sh bootstrap
#   bash inference/vllm/scripts/launch_remote_vllm_pool.sh start
#   bash inference/vllm/scripts/launch_remote_vllm_pool.sh stop
#   bash inference/vllm/scripts/launch_remote_vllm_pool.sh publish <adapter_dir> --policy-version <N>
set -eo pipefail
...
LOCAL_CHILD="${REPO_ROOT}/inference/vllm/scripts/_vllm_child.py"
LOCAL_RUNNER="${REPO_ROOT}/inference/vllm/scripts/_remote_vllm_runner.sh"
LOCAL_REQS="${REPO_ROOT}/inference/vllm/scripts/requirements-remote.txt"
