...
from rollout_fabric.schemas.episode_record import EpisodeRecord, TrustLevel
...
def _dict_to_record(d: dict) -> EpisodeRecord:
    from rollout_fabric.schemas.episode_record import Event, RewardEvent  # noqa: PLC0415
