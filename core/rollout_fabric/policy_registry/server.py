...
from rollout_fabric.policy_registry.fanout import fanout_to_pool
from rollout_fabric.schemas._gen import policy_registry_pb2, policy_registry_pb2_grpc
...
class PolicyRegistryServicer(policy_registry_pb2_grpc.PolicyRegistryServicer):
    ...
    def PublishPolicyVersion(self, request, context):  # noqa: N802
        ...
        try:
            from rollout_fabric.policy_registry.file_registry import (  # noqa: PLC0415
                PolicyManifest,
                write_manifest,
            )
